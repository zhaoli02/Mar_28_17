...
<link rel="shortcut icon" type="image/x-icon" href="${dir}/static/images/daisy_heart.ico" media="screen" /> 
	...
	<header>
		<nav id="nav">
			<ul>
				...
				<li><a href="${dir}/static/resume/resume.jsp" target="_blank">夫人简历</a></li>
				<!-- <li><a href="../static/resume/resume.jsp" target="_blank">夫人简历</a></li> -->
			</ul>
